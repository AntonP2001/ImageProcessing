...
Original file is located at
    https://colab.research.google.com/drive/1hnCcTn_VLzBXm1wcK0_kC6CkbV4bhDk2
"""
...
qt = QTree(stdThreshold = 1.1, minPixelSize = 2,img = image.copy())
qt.subdivide()
...
segm_gray = cv.cvtColor(tree_image, cv.COLOR_RGB2GRAY)

mask = cv.threshold(segm_gray, 59, 255, cv.THRESH_BINARY)[1]
