...
Original file is located at
    https://colab.research.google.com/drive/1ctl-JlK05xmHqvgEka8lVQJcDuUBCjyv
"""
...
rgb_main_img = cv2.imread('/content/drive/MyDrive/Обработка изображений/7/7_1.jpg')
plt.figure()
plt.imshow(cv2.cvtColor(rgb_main_img, cv2.COLOR_BGR2RGB))

template = cv2.imread('/content/drive/MyDrive/Обработка изображений/7/7_2.jpg')
plt.figure()
plt.imshow(cv2.cvtColor(template, cv2.COLOR_BGR2RGB))

gray_main_img = cv2.cvtColor(rgb_main_img, cv2.COLOR_BGR2GRAY)
...
k_1, des_1 = sift.detectAndCompute(gray_main_img, None)
...
image_key_point = cv2.drawKeypoints(gray_main_img, k_1, des_1, (0, 255, 255))
plt.figure()
...
image_with_knn_matches = cv2.drawMatchesKnn(gray_main_img,k_1,template_scale,k_2,good,None,flags=2)
plt.figure()
...
bandwidth = estimate_bandwidth(points, quantile=0.9)
